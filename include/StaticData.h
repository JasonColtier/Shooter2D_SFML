...
public:
	...
	inline static const std::vector<sf::Vector2f> BonusCollision = std::vector<sf::Vector2f>{ sf::Vector2f(0, 0), sf::Vector2f(-50.f, 0.0f), sf::Vector2f(-50.0f, 50.0f), sf::Vector2f(0.0f, 50.0f) };
